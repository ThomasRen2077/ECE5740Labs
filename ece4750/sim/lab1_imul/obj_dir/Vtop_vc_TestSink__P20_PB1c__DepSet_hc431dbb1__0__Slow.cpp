...
VL_ATTR_COLD void Vtop_vc_TestSink__P20_PB1c___ctor_var_reset(Vtop_vc_TestSink__P20_PB1c* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_vc_TestSink__P20_PB1c___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->__PVT__failed = VL_RAND_RESET_I(1);
    vlSelf->__PVT__verbose = VL_RAND_RESET_I(4);
    vlSelf->__PVT__m_curr = VL_RAND_RESET_I(32);
    vlSelf->__Vdly__reset_reg = VL_RAND_RESET_I(1);
    vlSelf->__Vdly__done = VL_RAND_RESET_I(1);
    vlSelf->__Vdly__failed = VL_RAND_RESET_I(1);
}
