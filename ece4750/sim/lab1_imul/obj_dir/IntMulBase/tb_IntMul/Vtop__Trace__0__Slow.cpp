...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedFst* tracep) {
    ...
    tracep->declBit(c+291,"istream_val_f",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    tracep->declBit(c+292,"ostream_rdy_f",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    ...
    tracep->declBus(c+272,"nextstate",1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 1,0);
    tracep->declBus(c+281,"a",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 31,0);
    tracep->declBus(c+282,"b",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 31,0);
    tracep->declBus(c+283,"counter",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 7,0);
    tracep->declBus(c+273,"next_a",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 31,0);
    tracep->declBus(c+274,"next_b",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 31,0);
    tracep->declBus(c+275,"next_ostream_msg",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 31,0);
    tracep->declBit(c+276,"next_ostream_val",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    tracep->declBus(c+284,"add_result",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+293,"p_nbits",-1, FST_VD_IMPLICIT,FST_VT_VCD_PARAMETER, false,-1, 31,0);
    ...
    tracep->declBus(c+294,"nchars",-1, FST_VD_IMPLICIT,FST_VT_VCD_PARAMETER, false,-1, 31,0);
    tracep->declBus(c+295,"nbits",-1, FST_VD_IMPLICIT,FST_VT_VCD_PARAMETER, false,-1, 31,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+272,(vlSelf->top__DOT__imul__DOT__nextstate),2);
    bufp->fullIData(oldp+273,(vlSelf->top__DOT__imul__DOT__next_a),32);
    bufp->fullIData(oldp+274,(vlSelf->top__DOT__imul__DOT__next_b),32);
    bufp->fullIData(oldp+275,(vlSelf->top__DOT__imul__DOT__next_ostream_msg),32);
    bufp->fullBit(oldp+276,(vlSelf->top__DOT__imul__DOT__next_ostream_val));
    ...
    bufp->fullCData(oldp+280,(vlSelf->top__DOT__imul__DOT__state),2);
    bufp->fullIData(oldp+281,(vlSelf->top__DOT__imul__DOT__a),32);
    bufp->fullIData(oldp+282,(vlSelf->top__DOT__imul__DOT__b),32);
    bufp->fullCData(oldp+283,(vlSelf->top__DOT__imul__DOT__counter),8);
    bufp->fullIData(oldp+284,(vlSelf->top__DOT__imul__DOT__add_result),32);
    ...
    bufp->fullCData(oldp+290,(vlSelf->top__DOT__imul__DOT__vc_trace__DOT__level),4);
    bufp->fullBit(oldp+291,(vlSelf->top__DOT__istream_val_f));
    bufp->fullBit(oldp+292,(vlSelf->top__DOT__ostream_rdy_f));
    bufp->fullIData(oldp+293,(0x20U),32);
    bufp->fullIData(oldp+294,(0x200U),32);
    bufp->fullIData(oldp+295,(0x1000U),32);
}
