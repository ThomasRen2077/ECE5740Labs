...
VL_ATTR_COLD void Vtop_lab1_imul_IntMulBase___configure_coverage(Vtop_lab1_imul_IntMulBase* vlSelf, bool first) {
    ...
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[16]), first, "IntMulBase.v", 81, 9, "", "v_branch/lab1_imul_IntMulBase", "if", "81-83");
    ...
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[19]), first, "IntMulBase.v", 70, 13, "", "v_line/lab1_imul_IntMulBase", "else", "78-79");
    ...
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[22]), first, "IntMulBase.v", 55, 6, "", "v_branch/lab1_imul_IntMulBase", "else", "58,86");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[23]), first, "IntMulBase.v", 54, 3, "", "v_line/lab1_imul_IntMulBase", "block", "54");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[24]), first, "IntMulBase.v", 106, 9, "", "v_branch/lab1_imul_IntMulBase", "if", "106");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[25]), first, "IntMulBase.v", 106, 10, "", "v_branch/lab1_imul_IntMulBase", "else", "107");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[26]), first, "IntMulBase.v", 110, 9, "", "v_branch/lab1_imul_IntMulBase", "if", "110");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[27]), first, "IntMulBase.v", 110, 10, "", "v_branch/lab1_imul_IntMulBase", "else", "111");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[28]), first, "IntMulBase.v", 114, 9, "", "v_branch/lab1_imul_IntMulBase", "if", "114");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[29]), first, "IntMulBase.v", 114, 10, "", "v_branch/lab1_imul_IntMulBase", "else", "115");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[30]), first, "IntMulBase.v", 109, 12, "", "v_line/lab1_imul_IntMulBase", "if", "109");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[31]), first, "IntMulBase.v", 109, 13, "", "v_line/lab1_imul_IntMulBase", "else", "113");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[32]), first, "IntMulBase.v", 105, 7, "", "v_line/lab1_imul_IntMulBase", "elsif", "105");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[33]), first, "IntMulBase.v", 104, 7, "", "v_line/lab1_imul_IntMulBase", "block", "104");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[34]), first, "IntMulBase.v", 133, 9, "", "v_branch/lab1_imul_IntMulBase", "if", "133-134");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[35]), first, "IntMulBase.v", 133, 10, "", "v_branch/lab1_imul_IntMulBase", "else", "136-137");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[36]), first, "IntMulBase.v", 130, 12, "", "v_branch/lab1_imul_IntMulBase", "if", "130-132");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[37]), first, "IntMulBase.v", 130, 13, "", "v_branch/lab1_imul_IntMulBase", "else", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[38]), first, "IntMulBase.v", 125, 7, "", "v_line/lab1_imul_IntMulBase", "elsif", "125-128");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[39]), first, "IntMulBase.v", 141, 7, "", "v_branch/lab1_imul_IntMulBase", "if", "141-142");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[40]), first, "IntMulBase.v", 141, 8, "", "v_branch/lab1_imul_IntMulBase", "else", "144-145");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[41]), first, "IntMulBase.v", 120, 3, "", "v_line/lab1_imul_IntMulBase", "block", "120-123");
}
