...
void Vtop___024root___eval(Vtop___024root* vlSelf) {
    ...
    // Init
    IData/*31:0*/ __Vtemp_h95b37539__0;
    IData/*31:0*/ __Vtemp_hc5d81bb2__0;
    IData/*31:0*/ __Vtemp_h77bf5129__0;
    // Body
    ...
    while (vlSelf->__VicoContinue) {
        ...
        if (vlSelf->__VicoTriggered.any()) {
            ...
            __Vtemp_h95b37539__0 = ((IData)(1U) + vlSelf->__VicoIterCount);
            vlSelf->__VicoIterCount = __Vtemp_h95b37539__0;
    ...
    while (vlSelf->__VnbaContinue) {
        ...
        while (vlSelf->__VactContinue) {
            ...
            if (vlSelf->__VactTriggered.any()) {
                ...
                __Vtemp_hc5d81bb2__0 = ((IData)(1U) 
                                        + vlSelf->__VactIterCount);
                vlSelf->__VactIterCount = __Vtemp_hc5d81bb2__0;
        ...
        if (vlSelf->__VnbaTriggered.any()) {
            ...
            __Vtemp_h77bf5129__0 = ((IData)(1U) + vlSelf->__VnbaIterCount);
            vlSelf->__VnbaIterCount = __Vtemp_h77bf5129__0;
...
void Vtop___024root___timing_commit(Vtop___024root* vlSelf) {
    ...
    if ((! (0x10ULL & vlSelf->__VactTriggered.word(0U)))) {
        vlSelf->__VtrigSched_h87bdc05d__0.commit("@([changed] top.ostream_val)");
    }
}
...
void Vtop___024root___timing_resume(Vtop___024root* vlSelf) {
    ...
    if ((0x10ULL & vlSelf->__VactTriggered.word(0U))) {
        vlSelf->__VtrigSched_h87bdc05d__0.resume("@([changed] top.ostream_val)");
    }
}
