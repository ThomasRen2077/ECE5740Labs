...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[4U])) {
        bufp->chgBit(oldp+271,(vlSelf->top__DOT__istream_rdy));
        bufp->chgBit(oldp+272,(vlSelf->top__DOT__ostream_val));
        bufp->chgIData(oldp+273,(vlSelf->top__DOT__ostream_msg),32);
        bufp->chgIData(oldp+274,(vlSelf->top__DOT__imul__DOT__vc_trace__DOT__cycles),32);
    }
