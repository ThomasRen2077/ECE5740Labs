...
void Vtop___024root___eval_triggers__act(Vtop___024root* vlSelf) {
    ...
    vlSelf->__VactTriggered.set(6U, ((IData)(vlSymsp->TOP__top__src__src__index_reg.__PVT__clk) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__top__src__src__index_reg____PVT__clk__0))));
    vlSelf->__VactTriggered.set(7U, ((IData)(vlSymsp->TOP__top__sink__sink__index_reg.__PVT__clk) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__top__sink__sink__index_reg____PVT__clk__0))));
    vlSelf->__VactTriggered.set(8U, ((IData)(vlSymsp->TOP__top__src__msg_delay__rand_delay_reg.__PVT__clk) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__top__src__msg_delay__rand_delay_reg____PVT__clk__0))));
    vlSelf->__VactTriggered.set(9U, ((IData)(vlSymsp->TOP__top__sink__msg_delay__rand_delay_reg.__PVT__clk) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__top__sink__msg_delay__rand_delay_reg____PVT__clk__0))));
    vlSelf->__VactTriggered.set(0xaU, ((~ (IData)(vlSymsp->TOP__top.clk)) 
...
void Vtop___024root___eval_nba(Vtop___024root* vlSelf) {
    ...
    if ((0xa0ULL & vlSelf->__VnbaTriggered.word(0U))) {
    ...
    if ((0x231ULL & vlSelf->__VnbaTriggered.word(0U))) {
    ...
    if ((0x10dULL & vlSelf->__VnbaTriggered.word(0U))) {
    ...
    if ((0x14dULL & vlSelf->__VnbaTriggered.word(0U))) {
    ...
    if ((0x33dULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vtop_lab1_imul_IntMulBase___nba_comb__TOP__top__imul__1((&vlSymsp->TOP__top__imul));
    }
    if ((0x37dULL & vlSelf->__VnbaTriggered.word(0U))) {
