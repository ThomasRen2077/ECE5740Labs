...
VL_INLINE_OPT VlCoroutine Vtop___024root___eval_initial__TOP__1(Vtop___024root* vlSelf) {
    ...
    __Vtask_top__DOT__test_task__31__b = 7U;
    __Vtask_top__DOT__test_task__31__a = 8U;
    co_await vlSelf->__VtrigSched_h3cadd47d__0.trigger(0U, 
                                                       nullptr, 
                                                       "@(negedge clk)", 
                                                       "tb_IntMul.v", 
    ...
    __Vtask_top__DOT__test_task__34__b = VL_RANDOM_I();
    __Vtask_top__DOT__test_task__34__a = VL_RANDOM_I();
    co_await vlSelf->__VtrigSched_h3cadd47d__0.trigger(0U, 
                                                       nullptr, 
                                                       "@(negedge clk)", 
                                                       "tb_IntMul.v", 
