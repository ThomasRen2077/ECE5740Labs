...
#ifndef VERILATED_VTOP_VC_TESTRANDDELAY__P20_H_
#define VERILATED_VTOP_VC_TESTRANDDELAY__P20_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_vc_TestRandDelay__P20 final : public VerilatedModule {
  public:
    // CELLS
    ...
    VL_IN(__PVT__in_msg,31,0);
    VL_OUT(__PVT__out_msg,31,0);
    ...
    // CONSTRUCTORS
    Vtop_vc_TestRandDelay__P20(Vtop__Syms* symsp, const char* v__name);
    ~Vtop_vc_TestRandDelay__P20();
    VL_UNCOPYABLE(Vtop_vc_TestRandDelay__P20);
