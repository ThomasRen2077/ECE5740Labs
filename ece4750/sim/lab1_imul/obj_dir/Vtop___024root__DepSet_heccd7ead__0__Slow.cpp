...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__b = VL_RAND_RESET_I(32);
    ...
    vlSelf->top__DOT__unnamedblk3__DOT__i = VL_RAND_RESET_I(32);
    ...
    vlSelf->top__DOT__src__DOT__src__DOT__index_next = VL_RAND_RESET_I(5);
    vlSelf->top__DOT__src__DOT__src__DOT__index = VL_RAND_RESET_I(5);
    ...
    vlSelf->top__DOT__imul__DOT__counter = VL_RAND_RESET_I(8);
    ...
    vlSelf->top__DOT__sink__DOT__sink__DOT__index_next = VL_RAND_RESET_I(5);
    vlSelf->top__DOT__sink__DOT__sink__DOT__index = VL_RAND_RESET_I(5);
