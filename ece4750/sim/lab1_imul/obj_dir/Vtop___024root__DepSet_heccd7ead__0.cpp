...
#endif
                VL_FATAL_MT("../lab1_imul/tb_IntMul.v", 20, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("../lab1_imul/tb_IntMul.v", 20, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("../lab1_imul/tb_IntMul.v", 20, "", "NBA region did not converge.");
            }
...
void Vtop___024root___timing_commit(Vtop___024root* vlSelf) {
    ...
    if ((! (8ULL & vlSelf->__VactTriggered.word(0U)))) {
        vlSelf->__VtrigSched_hc29b8aae__0.commit("@([changed] top.ostream_val)");
    }
}
...
void Vtop___024root___timing_resume(Vtop___024root* vlSelf) {
    ...
    if ((8ULL & vlSelf->__VactTriggered.word(0U))) {
        vlSelf->__VtrigSched_hc29b8aae__0.resume("@([changed] top.ostream_val)");
    }
}
