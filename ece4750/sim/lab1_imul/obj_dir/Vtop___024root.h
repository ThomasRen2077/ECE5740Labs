...
class alignas(VL_CACHE_LINE_BYTES) Vtop___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ top__DOT__imul__DOT____Vtogcov__finish;
        CData/*0:0*/ top__DOT__imul__DOT____Vtogcov__next_finish;
        CData/*0:0*/ top__DOT__imul__DOT____Vtogcov__checkone;
        CData/*4:0*/ top__DOT__imul__DOT____Vtogcov__i;
        CData/*4:0*/ top__DOT__imul__DOT____Vtogcov__shifts;
    ...
    struct {
        ...
        IData/*31:0*/ top__DOT__imul__DOT__Add__DOT____Vtogcov__in1;
