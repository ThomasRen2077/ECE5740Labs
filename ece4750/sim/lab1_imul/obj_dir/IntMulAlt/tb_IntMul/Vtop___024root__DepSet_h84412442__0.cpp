...
void Vtop___024root___eval_triggers__act(Vtop___024root* vlSelf) {
    ...
    vlSelf->__VactTriggered.set(3U, ((~ (IData)(vlSymsp->TOP__top.clk)) 
...
void Vtop_lab1_imul_IntMulAlt___act_comb__TOP__top__imul__1(Vtop_lab1_imul_IntMulAlt* vlSelf);
...
void Vtop___024root___eval_act(Vtop___024root* vlSelf) {
    ...
    if ((0x39ULL & vlSelf->__VactTriggered.word(0U))) {
        Vtop_lab1_imul_IntMulAlt___act_comb__TOP__top__imul__1((&vlSymsp->TOP__top__imul));
