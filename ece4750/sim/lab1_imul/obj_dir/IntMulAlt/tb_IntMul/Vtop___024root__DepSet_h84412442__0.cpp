...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->top__DOT__reset) {
        ...
        vlSelf->top__DOT__imul__DOT__a = (IData)((vlSelf->top__DOT__istream_msg 
                                                  >> 0x20U));
        vlSelf->top__DOT__imul__DOT__b = (IData)(vlSelf->top__DOT__istream_msg);
        vlSelf->top__DOT__ostream_msg = 0U;
        vlSelf->top__DOT__ostream_val = 0U;
        vlSelf->top__DOT__imul__DOT__finish = 1U;
