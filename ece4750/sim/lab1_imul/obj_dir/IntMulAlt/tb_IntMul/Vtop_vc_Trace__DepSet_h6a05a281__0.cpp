...
VL_INLINE_OPT void Vtop_vc_Trace___ico_sequent__TOP__top__imul__vc_trace__0(Vtop_vc_Trace* vlSelf) {
...
VL_INLINE_OPT void Vtop_vc_Trace___act_comb__TOP__top__imul__vc_trace__0(Vtop_vc_Trace* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
VL_INLINE_OPT void Vtop_vc_Trace___nba_comb__TOP__top__imul__vc_trace__0(Vtop_vc_Trace* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
