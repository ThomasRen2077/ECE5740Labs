...
void Vtop_top___configure_coverage(Vtop_top* vlSelf, bool first);

void Vtop_top::__Vconfigure(bool first) {
    if (false && first) {}  // Prevent unused
    Vtop_top___configure_coverage(this, first);
}
...
// Coverage
void Vtop_top::__vlCoverInsert(std::atomic<uint32_t>* countp, bool enable, const char* filenamep, int lineno, int column,
