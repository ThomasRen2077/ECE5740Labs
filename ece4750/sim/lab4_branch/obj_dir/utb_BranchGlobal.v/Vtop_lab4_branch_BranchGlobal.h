...
#ifndef VERILATED_VTOP_LAB4_BRANCH_BRANCHGLOBAL_H_
#define VERILATED_VTOP_LAB4_BRANCH_BRANCHGLOBAL_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_lab4_branch_BranchGlobal final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtop_lab4_branch_BranchGlobal(Vtop__Syms* symsp, const char* v__name);
    ~Vtop_lab4_branch_BranchGlobal();
    VL_UNCOPYABLE(Vtop_lab4_branch_BranchGlobal);
