...
VL_ATTR_COLD void Vtop___024root___eval_stl(Vtop___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VstlTriggered.word(0U))) {
        ...
        Vtop_lab4_branch_BranchGlobal___stl_sequent__TOP__top__DUT__0((&vlSymsp->TOP__top__DUT));
        Vtop_top___stl_sequent__TOP__top__1((&vlSymsp->TOP__top));
        Vtop_lab4_branch_BranchGlobal___stl_sequent__TOP__top__DUT__1((&vlSymsp->TOP__top__DUT));
    }
}
