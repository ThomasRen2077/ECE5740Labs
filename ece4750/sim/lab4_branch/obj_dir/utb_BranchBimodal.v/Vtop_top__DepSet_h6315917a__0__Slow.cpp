...
VL_ATTR_COLD void Vtop_top___ctor_var_reset(Vtop_top* vlSelf) {
    ...
    vlSelf->__PVT__unnamedblk15__DOT__x = VL_RAND_RESET_I(32);
    vlSelf->__PVT__unnamedblk15__DOT__unnamedblk16__DOT__y = VL_RAND_RESET_I(32);
    vlSelf->__PVT__unnamedblk17__DOT__x = VL_RAND_RESET_I(32);
    vlSelf->__PVT__unnamedblk17__DOT__unnamedblk18__DOT__y = VL_RAND_RESET_I(32);
    vlSelf->__PVT__unnamedblk19__DOT__x = VL_RAND_RESET_I(32);
    vlSelf->__PVT__unnamedblk19__DOT__unnamedblk20__DOT__y = VL_RAND_RESET_I(32);
    vlSelf->__PVT__unnamedblk21__DOT__x = VL_RAND_RESET_I(32);
    vlSelf->__PVT__unnamedblk21__DOT__unnamedblk22__DOT__y = VL_RAND_RESET_I(32);
    ...
    vlSelf->__Vtask_test_task__42__PC_f = VL_RAND_RESET_I(32);
    vlSelf->__Vtask_test_task__42__update_en_f = VL_RAND_RESET_I(1);
    vlSelf->__Vtask_test_task__42__update_val_f = VL_RAND_RESET_I(1);
    vlSelf->__Vtask_test_task__45__PC_f = VL_RAND_RESET_I(32);
    vlSelf->__Vtask_test_task__45__update_en_f = VL_RAND_RESET_I(1);
    vlSelf->__Vtask_test_task__45__update_val_f = VL_RAND_RESET_I(1);
    vlSelf->__Vtask_test_task__48__PC_f = VL_RAND_RESET_I(32);
    vlSelf->__Vtask_test_task__48__update_en_f = VL_RAND_RESET_I(1);
    vlSelf->__Vtask_test_task__48__update_val_f = VL_RAND_RESET_I(1);
    vlSelf->__Vtask_test_task__51__PC_f = VL_RAND_RESET_I(32);
    vlSelf->__Vtask_test_task__51__update_en_f = VL_RAND_RESET_I(1);
    vlSelf->__Vtask_test_task__51__update_val_f = VL_RAND_RESET_I(1);
}
