...
void Vtop_lab4_branch_BranchBimodal___ico_sequent__TOP__top__DUT__0(Vtop_lab4_branch_BranchBimodal* vlSelf);
...
void Vtop___024root___eval_ico(Vtop___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VicoTriggered.word(0U))) {
        ...
        Vtop_lab4_branch_BranchBimodal___ico_sequent__TOP__top__DUT__0((&vlSymsp->TOP__top__DUT));
    }
}
...
void Vtop_lab4_branch_BranchBimodal___act_comb__TOP__top__DUT__0(Vtop_lab4_branch_BranchBimodal* vlSelf);
...
void Vtop___024root___eval_act(Vtop___024root* vlSelf) {
    ...
    if ((6ULL & vlSelf->__VactTriggered.word(0U))) {
        ...
        Vtop_lab4_branch_BranchBimodal___act_comb__TOP__top__DUT__0((&vlSymsp->TOP__top__DUT));
        Vtop_top___act_comb__TOP__top__1((&vlSymsp->TOP__top));
    }
}

void Vtop_lab4_branch_BranchBimodal___nba_sequent__TOP__top__DUT__0(Vtop_lab4_branch_BranchBimodal* vlSelf);
void Vtop_top___nba_comb__TOP__top__0(Vtop_top* vlSelf);
void Vtop_lab4_branch_BranchBimodal___nba_comb__TOP__top__DUT__0(Vtop_lab4_branch_BranchBimodal* vlSelf);
void Vtop_lab4_branch_BranchBimodal___nba_comb__TOP__top__DUT__1(Vtop_lab4_branch_BranchBimodal* vlSelf);
...
void Vtop___024root___eval_nba(Vtop___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vtop_lab4_branch_BranchBimodal___nba_sequent__TOP__top__DUT__0((&vlSymsp->TOP__top__DUT));
        vlSelf->__Vm_traceActivity[3U] = 1U;
    }
    if ((6ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vtop_top___nba_comb__TOP__top__0((&vlSymsp->TOP__top));
        vlSelf->__Vm_traceActivity[4U] = 1U;
        Vtop_lab4_branch_BranchBimodal___nba_comb__TOP__top__DUT__0((&vlSymsp->TOP__top__DUT));
    }
    if ((7ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vtop_lab4_branch_BranchBimodal___nba_comb__TOP__top__DUT__1((&vlSymsp->TOP__top__DUT));
