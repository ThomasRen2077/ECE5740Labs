...
VL_INLINE_OPT VlCoroutine Vtop___024root___eval_initial__TOP__0(Vtop___024root* vlSelf) {
    ...
    // Body
    co_await Vtop___024root___eval_initial__TOP__0__0(vlSelf);
    co_await Vtop___024root___eval_initial__TOP__0__1(vlSelf);
}
...
#endif
                VL_FATAL_MT("utb_BranchGShare.v", 7, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("utb_BranchGShare.v", 7, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("utb_BranchGShare.v", 7, "", "NBA region did not converge.");
            }
...
void Vtop___024root___timing_commit(Vtop___024root* vlSelf) {
    ...
    if ((! (4ULL & vlSelf->__VactTriggered.word(0U)))) {
        vlSelf->__VtrigSched_hab79c6c5__0.commit("@(negedge clk)");
    }
}
...
void Vtop___024root___timing_resume(Vtop___024root* vlSelf) {
    ...
    if ((4ULL & vlSelf->__VactTriggered.word(0U))) {
        vlSelf->__VtrigSched_hab79c6c5__0.resume("@(negedge clk)");
    }
}
