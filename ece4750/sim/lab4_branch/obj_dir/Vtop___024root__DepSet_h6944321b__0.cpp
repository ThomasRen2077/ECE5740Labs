...
#endif
                VL_FATAL_MT("utb_BranchGlobal.v", 7, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("utb_BranchGlobal.v", 7, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("utb_BranchGlobal.v", 7, "", "NBA region did not converge.");
            }
