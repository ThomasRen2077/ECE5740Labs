...
VL_ATTR_COLD void Vtop_lab4_branch_BranchGshare___ctor_var_reset(Vtop_lab4_branch_BranchGshare* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtop_lab4_branch_BranchGshare___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->__PVT__PC_factor = VL_RAND_RESET_I(11);
    ...
    vlSelf->__Vtogcov__PC_factor = VL_RAND_RESET_I(11);
