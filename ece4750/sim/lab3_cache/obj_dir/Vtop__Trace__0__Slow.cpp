...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedFst* tracep) {
    ...
    tracep->declBit(c+15,"memresp_val",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    ...
    tracep->declBit(c+16,"cache_req_val",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    ...
    tracep->declBit(c+17,"cache_resp_rdy",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    tracep->declBit(c+7,"cache_resp_type",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    tracep->declBit(c+18,"reg_en_M0",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    tracep->declBit(c+32,"tarray_en",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    tracep->declBit(c+19,"tarray_wen",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    ...
    tracep->declBit(c+20,"darray_wen",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    tracep->declBit(c+21,"write_en_sel",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    tracep->declBit(c+22,"spill_one_word_done",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    tracep->declBit(c+23,"refill_one_word_req_sent",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    tracep->declBit(c+24,"refill_one_word_resp_received",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    tracep->declBit(c+35,"Spill_or_Refill_sel",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    ...
    tracep->declBit(c+15,"memresp_val",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1);
    ...
    tracep->declBit(c+16,"cache_req_val",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1);
    ...
    tracep->declBit(c+17,"cache_resp_rdy",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBit(c+7,"cache_resp_type",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBit(c+18,"reg_en_M0",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBit(c+32,"tarray_en",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBit(c+19,"tarray_wen",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1);
    ...
    tracep->declBit(c+20,"darray_wen",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBit(c+21,"write_en_sel",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBit(c+22,"spill_one_word_done",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBit(c+23,"refill_one_word_req_sent",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBit(c+24,"refill_one_word_resp_received",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBit(c+35,"Spill_or_Refill_sel",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1);
    ...
    tracep->declBit(c+25,"input_go",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    tracep->declBit(c+26,"ostall_Y",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    tracep->declBit(c+27,"stall_Y",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    tracep->declBit(c+36,"val_M0",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    tracep->declBit(c+37,"mem_req_type_M0",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    ...
    tracep->declBus(c+38,"state_reg",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 1,0);
    tracep->declBus(c+28,"state_next",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 1,0);
    tracep->declBit(c+41,"ostall_M0",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    tracep->declBit(c+13,"ostall_notrdy",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    tracep->declBit(c+29,"stall_M0",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+15,(vlSelf->top__DOT__memresp_val));
    bufp->fullBit(oldp+16,(vlSelf->top__DOT__cache_req_val));
    bufp->fullBit(oldp+17,(vlSelf->top__DOT__cache_resp_rdy));
    bufp->fullBit(oldp+18,((1U & (~ (IData)(vlSelf->top__DOT__DUT__DOT__stall_Y)))));
    bufp->fullBit(oldp+19,(vlSelf->top__DOT__tarray_wen));
    bufp->fullBit(oldp+20,(vlSelf->top__DOT__darray_wen));
    bufp->fullBit(oldp+21,(vlSelf->top__DOT__write_en_sel));
    bufp->fullBit(oldp+22,(vlSelf->top__DOT__spill_one_word_done));
    bufp->fullBit(oldp+23,(vlSelf->top__DOT__refill_one_word_req_sent));
    bufp->fullBit(oldp+24,(vlSelf->top__DOT__refill_one_word_resp_received));
    bufp->fullBit(oldp+25,(vlSelf->top__DOT__DUT__DOT__input_go));
    bufp->fullBit(oldp+26,((1U & (~ (IData)(vlSelf->top__DOT__DUT__DOT__input_go)))));
    bufp->fullBit(oldp+27,(vlSelf->top__DOT__DUT__DOT__stall_Y));
    bufp->fullCData(oldp+28,(vlSelf->top__DOT__DUT__DOT__state_next),2);
    bufp->fullBit(oldp+29,(vlSelf->top__DOT__DUT__DOT__stall_M0));
    ...
    bufp->fullBit(oldp+35,(vlSelf->top__DOT__Spill_or_Refill_sel));
    bufp->fullBit(oldp+36,(vlSelf->top__DOT__DUT__DOT__val_M0));
    bufp->fullBit(oldp+37,(vlSelf->top__DOT__DUT__DOT__mem_req_type_M0));
    bufp->fullCData(oldp+38,(vlSelf->top__DOT__DUT__DOT__state_reg),2);
    bufp->fullBit(oldp+39,(vlSelf->clk));
    bufp->fullBit(oldp+40,(vlSelf->linetrace));
    bufp->fullBit(oldp+41,(vlSelf->top__DOT__DUT__DOT__ostall_M0));
