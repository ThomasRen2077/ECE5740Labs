...
#endif
                VL_FATAL_MT("tb_Cache.v", 27, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("tb_Cache.v", 27, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("tb_Cache.v", 27, "", "NBA region did not converge.");
            }
