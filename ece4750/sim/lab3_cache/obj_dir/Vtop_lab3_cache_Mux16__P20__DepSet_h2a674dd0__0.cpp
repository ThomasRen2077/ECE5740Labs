...
VL_INLINE_OPT void Vtop_lab3_cache_Mux16__P20___act_comb__TOP__top__DUT__output_mux__0(Vtop_lab3_cache_Mux16__P20* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_lab3_cache_Mux16__P20___act_comb__TOP__top__DUT__output_mux__0\n"); );
    // Body
