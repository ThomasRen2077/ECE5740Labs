...
class Vtop_lab3_cache_CacheAltDpath;
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_top final : public VerilatedModule {
  public:
    // CELLS
    Vtop_lab3_cache_CacheAltDpath* __PVT__DUT;
    ...
    CData/*0:0*/ __PVT__current_lru;
    CData/*0:0*/ __PVT__flush_dirty;
