...
VL_ATTR_COLD void Vtop_vc_Mux2___stl_sequent__TOP__top__DUT__FLush_dirty_mux__0(Vtop_vc_Mux2* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_vc_Mux2___stl_sequent__TOP__top__DUT__FLush_dirty_mux__0\n"); );
    // Body
...
VL_ATTR_COLD void Vtop_vc_Mux2___stl_sequent__TOP__top__DUT__FLush_dirty_mux__1(Vtop_vc_Mux2* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_vc_Mux2___stl_sequent__TOP__top__DUT__FLush_dirty_mux__1\n"); );
    // Body
...
VL_ATTR_COLD void Vtop_vc_Mux2___configure_coverage(Vtop_vc_Mux2* vlSelf, bool first) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_vc_Mux2___configure_coverage\n"); );
    // Body
    if (false && first) {}  // Prevent unused
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[1140]), first, "../vc/muxes.v", 16, 30, "", "v_toggle/vc_Mux2", "in0[0]", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[1141]), first, "../vc/muxes.v", 16, 35, "", "v_toggle/vc_Mux2", "in1[0]", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[1142]), first, "../vc/muxes.v", 17, 30, "", "v_toggle/vc_Mux2", "sel", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[1143]), first, "../vc/muxes.v", 18, 30, "", "v_toggle/vc_Mux2", "out[0]", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[1144]), first, "../vc/muxes.v", 24, 12, "", "v_line/vc_Mux2", "case", "24");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[1145]), first, "../vc/muxes.v", 25, 12, "", "v_line/vc_Mux2", "case", "25");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[1146]), first, "../vc/muxes.v", 26, 7, "", "v_line/vc_Mux2", "case", "26");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[1147]), first, "../vc/muxes.v", 21, 3, "", "v_line/vc_Mux2", "block", "21-23");
}
