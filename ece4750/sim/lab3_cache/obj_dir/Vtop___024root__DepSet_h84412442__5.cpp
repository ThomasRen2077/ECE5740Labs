...
VL_INLINE_OPT void Vtop___024root___nba_comb__TOP__5(Vtop___024root* vlSelf) {
    ...
    if ((0U == (IData)(vlSelf->top__DOT__cache__DOT__icache__DOT__ctrl__DOT__state_reg))) {
        ...
        vlSelf->top__DOT__cache__DOT__icache__DOT__darray_wen 
            = (1U & ((1U != (IData)(vlSelf->top__DOT__cache__DOT__icache__DOT__ctrl__DOT__state_reg)) 
                     & (IData)(vlSelf->top__DOT__cache__DOT__icache__DOT__refill_resp_done)));
        vlSelf->top__DOT__cache__DOT__icache__DOT__write_en_sel = 0U;
    }
