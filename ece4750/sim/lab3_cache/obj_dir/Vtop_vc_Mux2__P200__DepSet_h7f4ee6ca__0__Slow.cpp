...
VL_ATTR_COLD void Vtop_vc_Mux2__P200___stl_sequent__TOP__top__DUT__way_output_sel_mux__0(Vtop_vc_Mux2__P200* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_vc_Mux2__P200___stl_sequent__TOP__top__DUT__way_output_sel_mux__0\n"); );
    // Body
    if (((IData)(vlSelf->__PVT__sel) ^ (IData)(vlSelf->__Vtogcov__sel))) {
        vlSymsp->__Vcoverage[1407].fetch_add(1, std::memory_order_relaxed);
        vlSelf->__Vtogcov__sel = vlSelf->__PVT__sel;
...
VL_ATTR_COLD void Vtop_vc_Mux2__P200___configure_coverage(Vtop_vc_Mux2__P200* vlSelf, bool first) {
    ...
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[1407]), first, "../vc/muxes.v", 17, 30, "", "v_toggle/vc_Mux2__P200", "sel", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[1408]), first, "../vc/muxes.v", 24, 12, "", "v_line/vc_Mux2__P200", "case", "24");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[1409]), first, "../vc/muxes.v", 25, 12, "", "v_line/vc_Mux2__P200", "case", "25");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[1410]), first, "../vc/muxes.v", 26, 7, "", "v_line/vc_Mux2__P200", "case", "26");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[1411]), first, "../vc/muxes.v", 21, 3, "", "v_line/vc_Mux2__P200", "block", "21-23");
}
