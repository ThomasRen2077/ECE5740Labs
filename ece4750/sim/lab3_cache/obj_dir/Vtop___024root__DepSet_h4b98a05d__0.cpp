...
VL_INLINE_OPT VlCoroutine Vtop___024root___eval_initial__TOP__0(Vtop___024root* vlSelf) {
    ...
    co_await vlSelf->__VdlySched.delay(2ULL, nullptr, 
                                       ...
                                       119);
    vlSelf->__Vm_traceActivity[2U] = 1U;
    vlSelf->top__DOT__cache_req_rdy = 1U;
    co_await vlSelf->__VdlySched.delay(0x20ULL, nullptr, 
                                       "utb_CacheBaseCtrl.v", 
                                       122);
    vlSelf->__Vm_traceActivity[2U] = 1U;
    ...
    co_await vlSelf->__VdlySched.delay(0x20ULL, nullptr, 
                                       ...
                                       128);
    vlSelf->__Vm_traceActivity[2U] = 1U;
    vlSelf->top__DOT__refill_req_done = 1U;
    vlSelf->top__DOT__cache_resp_val = 1U;
    vlSelf->top__DOT__cache_resp_type = 1U;
    co_await vlSelf->__VdlySched.delay(0x20ULL, nullptr, 
                                       "utb_CacheBaseCtrl.v", 
                                       133);
    vlSelf->__Vm_traceActivity[2U] = 1U;
    vlSelf->top__DOT__refill_resp_done = 1U;
    vlSelf->top__DOT__cache_resp_val = 0U;
    vlSelf->top__DOT__cache_resp_type = 0U;
    co_await vlSelf->__VdlySched.delay(2ULL, nullptr, 
                                       "utb_CacheBaseCtrl.v", 
    ...
    co_await vlSelf->__VdlySched.delay(0x14ULL, nullptr, 
                                       ...
                                       200);
    vlSelf->__Vm_traceActivity[2U] = 1U;
    VL_FINISH_MT("utb_CacheBaseCtrl.v", 203, "");
...
VL_INLINE_OPT void Vtop___024root___nba_comb__TOP__1(Vtop___024root* vlSelf) {
    ...
    if ((0U != (IData)(vlSelf->top__DOT__DUT__DOT__state_reg))) {
        ...
        vlSelf->top__DOT__tarray_wen = ((1U != (IData)(vlSelf->top__DOT__DUT__DOT__state_reg)) 
                                        & (IData)(vlSelf->top__DOT__refill_resp_done));
    } else {
