...
#endif
                VL_FATAL_MT("utb_ProcAltDpath.v", 8, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__IntMulAlt_reqstream_msg = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__IntMulAlt_respstream_msg = VL_RAND_RESET_I(32);
    ...
    vlSelf->top__DOT__imul_ostream_rdy_X = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT____Vtogcov__IntMulAlt_reqstream_msg = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT____Vtogcov__IntMulAlt_respstream_msg = VL_RAND_RESET_I(32);
    ...
    vlSelf->top__DOT____Vtogcov__imul_ostream_rdy_X = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__DUT__DOT__op1_byp_D = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__DUT__DOT__op2_byp_D = VL_RAND_RESET_I(32);
    ...
    vlSelf->top__DOT__DUT__DOT__op2_byp_X = VL_RAND_RESET_I(32);
    ...
    vlSelf->top__DOT__DUT__DOT____Vtogcov__op1_byp_D = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__DUT__DOT____Vtogcov__op2_byp_D = VL_RAND_RESET_I(32);
