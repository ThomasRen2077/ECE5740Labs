...
#endif
                VL_FATAL_MT("utb_ProcBaseCtrl.v", 9, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("utb_ProcBaseCtrl.v", 9, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("utb_ProcBaseCtrl.v", 9, "", "NBA region did not converge.");
            }
