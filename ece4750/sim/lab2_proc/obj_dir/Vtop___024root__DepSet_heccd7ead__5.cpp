...
#endif
                VL_FATAL_MT("../lab2_proc/tb_Proc.v", 24, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("../lab2_proc/tb_Proc.v", 24, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("../lab2_proc/tb_Proc.v", 24, "", "NBA region did not converge.");
            }
