...
#endif
                VL_FATAL_MT("utb_ProcDpathImmGen.v", 8, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("utb_ProcDpathImmGen.v", 8, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("utb_ProcDpathImmGen.v", 8, "", "NBA region did not converge.");
            }
