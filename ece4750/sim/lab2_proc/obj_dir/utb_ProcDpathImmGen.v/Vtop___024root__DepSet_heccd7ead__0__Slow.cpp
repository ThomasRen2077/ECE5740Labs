...
#endif
                VL_FATAL_MT("utb_ProcDpathImmGen.v", 8, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT____Vtogcov__imm_type = VL_RAND_RESET_I(3);
    vlSelf->top__DOT____Vtogcov__inst = VL_RAND_RESET_I(32);
    vlSelf->top__DOT____Vtogcov__imm = VL_RAND_RESET_I(32);
    }
