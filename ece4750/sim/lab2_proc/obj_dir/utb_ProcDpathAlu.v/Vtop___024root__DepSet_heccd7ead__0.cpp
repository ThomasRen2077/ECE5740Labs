...
#endif
                VL_FATAL_MT("utb_ProcDpathAlu.v", 11, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("utb_ProcDpathAlu.v", 11, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("utb_ProcDpathAlu.v", 11, "", "NBA region did not converge.");
            }
