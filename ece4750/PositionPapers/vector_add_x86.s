...
vector_add_x86:     file format elf64-x86-64
...
0000000000400403 <_start>:
  400403:	31 ed                	xor    %ebp,%ebp
  400405:	49 89 d1             	mov    %rdx,%r9
  400408:	5e                   	pop    %rsi
  400409:	48 89 e2             	mov    %rsp,%rdx
  40040c:	48 83 e4 f0          	and    $0xfffffffffffffff0,%rsp
  400410:	50                   	push   %rax
  400411:	54                   	push   %rsp
  400412:	49 c7 c0 90 05 40 00 	mov    $0x400590,%r8
  400419:	48 c7 c1 20 05 40 00 	mov    $0x400520,%rcx
  400420:	48 c7 c7 00 04 40 00 	mov    $0x400400,%rdi
  400427:	e8 b4 ff ff ff       	callq  4003e0 <__libc_start_main@plt>
  40042c:	f4                   	hlt    
  40042d:	0f 1f 00             	nopl   (%rax)
...
00000000004004f0 <vector_add>:
  4004f0:	31 c0                	xor    %eax,%eax
  4004f2:	85 c9                	test   %ecx,%ecx
  4004f4:	7e 1e                	jle    400514 <vector_add+0x24>
  4004f6:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
  4004fd:	00 00 00 
  400500:	44 8b 04 87          	mov    (%rdi,%rax,4),%r8d
  400504:	44 03 04 86          	add    (%rsi,%rax,4),%r8d
  400508:	44 89 04 82          	mov    %r8d,(%rdx,%rax,4)
  40050c:	48 83 c0 01          	add    $0x1,%rax
  400510:	39 c1                	cmp    %eax,%ecx
  400512:	7f ec                	jg     400500 <vector_add+0x10>
  400514:	f3 c3                	repz retq 
