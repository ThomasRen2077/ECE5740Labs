...
void Vtop_std__03a__03asemaphore__Vclpkg___configure_coverage(Vtop_std__03a__03asemaphore__Vclpkg* vlSelf, bool first);

void Vtop_std__03a__03asemaphore__Vclpkg::__Vconfigure(bool first) {
    if (false && first) {}  // Prevent unused
    Vtop_std__03a__03asemaphore__Vclpkg___configure_coverage(this, first);
}
...
// Coverage
void Vtop_std__03a__03asemaphore__Vclpkg::__vlCoverInsert(std::atomic<uint32_t>* countp, bool enable, const char* filenamep, int lineno, int column,
