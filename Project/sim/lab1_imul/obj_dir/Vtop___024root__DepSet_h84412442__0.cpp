...
VL_INLINE_OPT VlCoroutine Vtop___024root___eval_initial__TOP__0(Vtop___024root* vlSelf) {
    ...
    // Init
    IData/*31:0*/ __Vtask_top__DOT__test_task__8__a;
    __Vtask_top__DOT__test_task__8__a = 0;
    IData/*31:0*/ __Vtask_top__DOT__test_task__8__b;
    __Vtask_top__DOT__test_task__8__b = 0;
    IData/*31:0*/ __Vtask_top__DOT__test_task__11__a;
    __Vtask_top__DOT__test_task__11__a = 0;
    IData/*31:0*/ __Vtask_top__DOT__test_task__11__b;
    __Vtask_top__DOT__test_task__11__b = 0;
    // Body
    ...
    if (vlSymsp->_vm_contextp__->assertOn()) {
        if (VL_LIKELY((6U == vlSelf->top__DOT__ostream_msg))) {
            ...
            VL_WRITEF("[%0t] %%Error: tb_IntMul.v:116: Assertion failed in %Ntop: Failed: in0 = %10#, in1 = %10#, out = %10#\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name(),
                      32,vlSelf->top__DOT__istream_msg_a,
                      32,vlSelf->top__DOT__istream_msg_b,
                      32,vlSelf->top__DOT__ostream_msg);
            VL_STOP_MT("../lab1_imul/tb_IntMul.v", 116, "");
        }
    }
    co_await vlSelf->__VdlySched.delay(0xaULL, nullptr, 
                                       "../lab1_imul/tb_IntMul.v", 
    ...
    if (vlSymsp->_vm_contextp__->assertOn()) {
        if (VL_LIKELY((0x14U == vlSelf->top__DOT__ostream_msg))) {
            ...
            Vtop___024unit____Vdpiimwrap_fail_TOP____024unit();
            VL_WRITEF("[%0t] %%Error: tb_IntMul.v:150: Assertion failed in %Ntop: Failed: in0 = %10#, in1 = %10#, out = %10#\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name(),
                      32,vlSelf->top__DOT__istream_msg_a,
                      32,vlSelf->top__DOT__istream_msg_b,
                      32,vlSelf->top__DOT__ostream_msg);
            VL_STOP_MT("../lab1_imul/tb_IntMul.v", 150, "");
        }
    }
    co_await vlSelf->__VdlySched.delay(0xaULL, nullptr, 
                                       "../lab1_imul/tb_IntMul.v", 
    ...
    if (vlSymsp->_vm_contextp__->assertOn()) {
        if (VL_LIKELY((0xcU == vlSelf->top__DOT__ostream_msg))) {
            ...
            Vtop___024unit____Vdpiimwrap_fail_TOP____024unit();
            VL_WRITEF("[%0t] %%Error: tb_IntMul.v:184: Assertion failed in %Ntop: Failed: in0 = %10#, in1 = %10#, out = %10#\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name(),
                      32,vlSelf->top__DOT__istream_msg_a,
                      32,vlSelf->top__DOT__istream_msg_b,
                      32,vlSelf->top__DOT__ostream_msg);
            VL_STOP_MT("../lab1_imul/tb_IntMul.v", 184, "");
        }
    }
    co_await vlSelf->__VdlySched.delay(0xaULL, nullptr, 
                                       "../lab1_imul/tb_IntMul.v", 
    ...
    if (vlSymsp->_vm_contextp__->assertOn()) {
        if (VL_LIKELY((0x82U == vlSelf->top__DOT__ostream_msg))) {
            ...
            Vtop___024unit____Vdpiimwrap_fail_TOP____024unit();
            VL_WRITEF("[%0t] %%Error: tb_IntMul.v:218: Assertion failed in %Ntop: Failed: in0 = %10#, in1 = %10#, out = %10#\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name(),
                      32,vlSelf->top__DOT__istream_msg_a,
                      32,vlSelf->top__DOT__istream_msg_b,
                      32,vlSelf->top__DOT__ostream_msg);
            VL_STOP_MT("../lab1_imul/tb_IntMul.v", 218, "");
        }
    }
    co_await vlSelf->__VdlySched.delay(0xaULL, nullptr, 
                                       "../lab1_imul/tb_IntMul.v", 
    ...
    __Vtask_top__DOT__test_task__8__b = 7U;
    __Vtask_top__DOT__test_task__8__a = 8U;
    co_await vlSelf->__VtrigSched_h3d404bd2__0.trigger(0U, 
                                                       nullptr, 
                                                       "@(negedge clk)", 
                                                       "../lab1_imul/tb_IntMul.v", 
                                                       267);
    vlSelf->__Vm_traceActivity[2U] = 1U;
    vlSelf->top__DOT__istream_msg_a = __Vtask_top__DOT__test_task__8__a;
    vlSelf->top__DOT__istream_msg_b = __Vtask_top__DOT__test_task__8__b;
    vlSelf->top__DOT__istream_val = 1U;
    ...
    if (vlSymsp->_vm_contextp__->assertOn()) {
        if (VL_LIKELY(((__Vtask_top__DOT__test_task__8__a 
                        * __Vtask_top__DOT__test_task__8__b) 
                       == vlSelf->top__DOT__ostream_msg))) {
            if (VL_UNLIKELY(vlSymsp->_vm_contextp__->assertOn())) {
                Vtop___024unit____Vdpiimwrap_pass_TOP____024unit();
                VL_WRITEF("OK: in0 = %10#, in1 = %10#, out = %10#\n",
                          32,__Vtask_top__DOT__test_task__8__a,
                          32,__Vtask_top__DOT__test_task__8__b,
                          32,vlSelf->top__DOT__ostream_msg);
            }
        } else if (VL_UNLIKELY(vlSymsp->_vm_contextp__->assertOn())) {
            Vtop___024unit____Vdpiimwrap_fail_TOP____024unit();
            VL_WRITEF("[%0t] %%Error: tb_IntMul.v:290: Assertion failed in %Ntop.test_task: Failed: in0 = %10#, in1 = %10#, out = %10#\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name(),
                      32,__Vtask_top__DOT__test_task__8__a,
                      32,__Vtask_top__DOT__test_task__8__b,
                      32,vlSelf->top__DOT__ostream_msg);
            VL_STOP_MT("../lab1_imul/tb_IntMul.v", 290, "");
        }
    }
    co_await vlSelf->__VtrigSched_h3d404bd2__0.trigger(0U, 
                                                       nullptr, 
    ...
    __Vtask_top__DOT__test_task__11__b = VL_RANDOM_I();
    __Vtask_top__DOT__test_task__11__a = VL_RANDOM_I();
    co_await vlSelf->__VtrigSched_h3d404bd2__0.trigger(0U, 
                                                       nullptr, 
                                                       "@(negedge clk)", 
                                                       "../lab1_imul/tb_IntMul.v", 
                                                       267);
    vlSelf->__Vm_traceActivity[2U] = 1U;
    vlSelf->top__DOT__istream_msg_a = __Vtask_top__DOT__test_task__11__a;
    vlSelf->top__DOT__istream_msg_b = __Vtask_top__DOT__test_task__11__b;
    vlSelf->top__DOT__istream_val = 1U;
    vlSelf->top__DOT__ostream_rdy = 0U;
    while ((1U & (~ (IData)(vlSelf->top__DOT__istream_rdy)))) {
        co_await vlSelf->__VtrigSched_h3d404bd2__0.trigger(0U, 
    ...
    if (vlSymsp->_vm_contextp__->assertOn()) {
        if (VL_LIKELY(((__Vtask_top__DOT__test_task__11__a 
                        * __Vtask_top__DOT__test_task__11__b) 
                       == vlSelf->top__DOT__ostream_msg))) {
            if (VL_UNLIKELY(vlSymsp->_vm_contextp__->assertOn())) {
                Vtop___024unit____Vdpiimwrap_pass_TOP____024unit();
                VL_WRITEF("OK: in0 = %10#, in1 = %10#, out = %10#\n",
                          32,__Vtask_top__DOT__test_task__11__a,
                          32,__Vtask_top__DOT__test_task__11__b,
                          32,vlSelf->top__DOT__ostream_msg);
            }
        } else if (VL_UNLIKELY(vlSymsp->_vm_contextp__->assertOn())) {
            Vtop___024unit____Vdpiimwrap_fail_TOP____024unit();
    ...
    co_await vlSelf->__VdlySched.delay(0xaULL, nullptr, 
                                       ...
                                       251);
    vlSelf->__Vm_traceActivity[2U] = 1U;
    VL_FINISH_MT("../lab1_imul/tb_IntMul.v", 252, "");
    vlSelf->__Vm_traceActivity[2U] = 1U;
}
...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    // Init
    CData/*0:0*/ __Vdly__top__DOT__ostream_val;
    __Vdly__top__DOT__ostream_val = 0;
    CData/*5:0*/ __Vdly__top__DOT__imul__DOT__counter;
    __Vdly__top__DOT__imul__DOT__counter = 0;
    // Body
    vlSymsp->__Vcoverage[392].fetch_add(1, std::memory_order_relaxed);
    __Vdly__top__DOT__ostream_val = vlSelf->top__DOT__ostream_val;
    ...
    if ((1U & (~ (IData)(vlSelf->top__DOT__reset)))) {
        ...
        if ((0U == (IData)(vlSelf->top__DOT__imul__DOT__state))) {
            ...
            __Vdly__top__DOT__ostream_val = vlSelf->top__DOT__imul__DOT__next_ostream_val;
            ...
            __Vdly__top__DOT__imul__DOT__counter = 
                (0x3fU & ((IData)(1U) + (IData)(vlSelf->top__DOT__imul__DOT__counter)));
            vlSelf->top__DOT__imul__DOT__a = vlSelf->top__DOT__imul__DOT__next_a;
            vlSelf->top__DOT__imul__DOT__b = vlSelf->top__DOT__imul__DOT__next_b;
            vlSelf->top__DOT__ostream_msg = vlSelf->top__DOT__imul__DOT__next_ostream_msg;
            __Vdly__top__DOT__ostream_val = vlSelf->top__DOT__imul__DOT__next_ostream_val;
    ...
    vlSelf->top__DOT__ostream_val = __Vdly__top__DOT__ostream_val;
