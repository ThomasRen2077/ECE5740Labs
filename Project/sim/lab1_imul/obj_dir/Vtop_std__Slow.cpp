...
void Vtop_std___configure_coverage(Vtop_std* vlSelf, bool first);

void Vtop_std::__Vconfigure(bool first) {
    if (false && first) {}  // Prevent unused
    Vtop_std___configure_coverage(this, first);
}
...
// Coverage
void Vtop_std::__vlCoverInsert(std::atomic<uint32_t>* countp, bool enable, const char* filenamep, int lineno, int column,
