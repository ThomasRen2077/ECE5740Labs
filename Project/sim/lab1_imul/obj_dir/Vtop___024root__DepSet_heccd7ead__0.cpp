...
#endif
                VL_FATAL_MT("../lab1_imul/tb_IntMul.v", 131, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("../lab1_imul/tb_IntMul.v", 131, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("../lab1_imul/tb_IntMul.v", 131, "", "NBA region did not converge.");
            }
